...
public class output {
    ...
    private void mainMenuAdmin() {// 사장 메인메뉴
        while (true) {
            ...
            switch (mainFlag) {
                case 1 -> management.adminReservation.storeJoin();// 매장등록
                case 2 -> management.adminReservation.reserveManAdmin();// 예약관리
                case 3 -> management.adminReservation.reserveNow();// 예약현황
                case 4 -> {
                    System.out.println("\n*로그아웃합니다.");// 로그아웃
                    return;
                }
    ...
    private void mainMenuCustomer() {// 고객 메인메뉴
        while (true) {
            ...
            mainFlag = Integer.parseInt(select);
            switch (mainFlag) {
                case 1 -> management.customerReservation.reserve();// 예약하기
                case 2 -> management.customerReservation.reserveManCustomer();// 예약관리
                case 3 -> {
                    System.out.println("\n*로그아웃합니다.");// 로그아웃
                    return;
                }
